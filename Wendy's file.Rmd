...
finding_weights <- function(dataset = all_elites, events = women_events){
  ...
  # counting how many median scores are non zeros 
...
finding_weights <- function(dataset = all_elites, events = women_events){
  ...
  # counting how many median scores are non zeros 
  specified_columns <- women_events
  all_elites_event$non_zero_count <- rowSums(all_elites_event[, specified_columns] != 0)
...
get_teams <- function(data = all_elites_c){
  all_elites_teams <- all_elites_c %>%
