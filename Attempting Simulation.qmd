...
#   filter(clean_name == "Arianna BELARDELLI", Apparatus == "BB")
# 
# nrow(athlete_data)
...
event_sim <- function(event, dataset){
  ...
  for (athlete in all_elites$clean_name){
    ...
    all_elites <- all_elites %>%
      mutate()
    }
 all_elites_event <- cbind(all_elites, event_sim = all_points)
