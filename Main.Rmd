...
range_of_rank_w <- ggplot(data = w_team_usa_no_zero, aes(y= clean_name, x = Rank))+
...
range_of_rank_m <- ggplot(data = m_team_usa_no_zero, aes(y= clean_name, x = Rank))+
  geom_point( alpha = .5, color = "#3b4992ff")+
  theme_light()+
  scale_color_aaas()+
  theme(
...
```{r range_of_rank_together, fig.cap = "Every Competition Rank for each team USA Athlete by Apparatus", fig.fullwidth = TRUE, fig.height = 7, fig.width = 7}
