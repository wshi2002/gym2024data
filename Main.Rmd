...
```{r range-of-score-w, fig.cap = "Range of Rank at all Competitions for US Womens Team"}
...
range_of_score_m <- ggplot(data = m_team_usa, aes(y= clean_name, x = Score))+
  geom_point( alpha = .5, color = "#3b4992ff")+
  theme_light()+
  scale_color_aaas()+
  labs(
...
ggplot(m_team_usa, aes(x = competition_number, y = mean(Score)))+
  geom_point()+
...
>>>>>>> 629134ab7161a9b631cc302428a6d8700e8859c9
...
```
<<<<<<< HEAD
```{r adding-winningmost-countries-graphs, fig.cap = "Each Athletes Rank for Olympic Qualified Countries across all Competitions"}
