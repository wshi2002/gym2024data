...
for (i in 1:numSimulations) {
  ...
  indivAA_result <- event_sim_indiv(c("VT", "SR", "PH", "PB", "HB", "FX"), all_indiv)
  SR_result <- event_sim_indiv(c("SR"), all_indiv)
  VT_result <- event_sim_indiv(c("VT1", "VT2"), all_indiv)
  PH_result <- event_sim_indiv(c("PH"), all_indiv)
  PB_result <- event_sim_indiv(c("PB"), all_indiv)
  HB_result <- event_sim_indiv(c("HB"), all_indiv)
...
saveRDS(simulations_m, file = "simulations_m.rds")
```


```{r}
table_summary <- simulations_m[[1]]@teamSummary
```
