...
```{r range-of-score-w, fig.cap = "Competition Scores for Each Female Team USA Athlete by Apparatus", fig.margin = TRUE, fig.width = 4, fig.height = 3}
...
```{r range-of-score-m, fig.cap = "Competition Scores for Each Male team USA Athlete by Apparatus", fig.margin = TRUE, fig.height = 4, fig.width = 4}
...
grid.arrange(range_of_rank_m, range_of_rank_w, nrow = 2)
