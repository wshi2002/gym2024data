...
The same process above was repeated for the women's event. The results are included in the table below, with the names of the athletes and the percentage of simulations where the United States had the highest weighted medal count.
...
grid.arrange(diff_qual_v_final_m, diff_qual_v_final_w, ncol = 2)
```
