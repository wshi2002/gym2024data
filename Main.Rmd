...
combined_plot <- grid.arrange(winningmost_country_women, winningmost_country_men, ncol = 2)

combined_plot <- combined_plot + annotate("text", x = 0.5, y = 1, label = "test", vjust = 2, hjust = 0.6, size = 6)
```
...
```{r output-penalties}
grid.arrange(penalty_m, penalty_w, ncol = 2)
```
